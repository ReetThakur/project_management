<x-app-layout>
    <x-slot name="header">
        <h2 class="text-2xl font-bold text-gray-900 dark:text-white">{{ __('Create Project') }}</h2>
    </x-slot>
    <div class="py-8">
                ...
                <form action="{{ route('projects.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <x-text-input id="start_date" name="start_date" type="date" class="block w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white text-black focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" :value="old('start_date')" required />
